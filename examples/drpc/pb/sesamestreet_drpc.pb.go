...
type DRPCCookieMonsterClient interface {
	...
	CheckJar(ctx context.Context, in *Cookie) (*CookieJar, error)
	EatCookie(ctx context.Context, in *Cookie) (*CookieJar, error)
}
...
func (c *drpcCookieMonsterClient) CheckJar(ctx context.Context, in *Cookie) (*CookieJar, error) {
	out := new(CookieJar)
	err := c.cc.Invoke(ctx, "/sesamestreet.CookieMonster/CheckJar", drpcEncoding_File_sesamestreet_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcCookieMonsterClient) EatCookie(ctx context.Context, in *Cookie) (*CookieJar, error) {
	out := new(CookieJar)
...
type DRPCCookieMonsterServer interface {
	CheckJar(context.Context, *Cookie) (*CookieJar, error)
	EatCookie(context.Context, *Cookie) (*CookieJar, error)
}

type DRPCCookieMonsterUnimplementedServer struct{}

func (s *DRPCCookieMonsterUnimplementedServer) CheckJar(context.Context, *Cookie) (*CookieJar, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCCookieMonsterUnimplementedServer) EatCookie(context.Context, *Cookie) (*CookieJar, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

type DRPCCookieMonsterDescription struct{}

func (DRPCCookieMonsterDescription) NumMethods() int { return 2 }

func (DRPCCookieMonsterDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/sesamestreet.CookieMonster/CheckJar", drpcEncoding_File_sesamestreet_proto{},
			...
			}, DRPCCookieMonsterServer.CheckJar, true
	case 1:
...
type DRPCCookieMonster_CheckJarStream interface {
	drpc.Stream
	SendAndClose(*CookieJar) error
}

type drpcCookieMonster_CheckJarStream struct {
	drpc.Stream
}

func (x *drpcCookieMonster_CheckJarStream) SendAndClose(m *CookieJar) error {
...
func (x *drpcCookieMonster_EatCookieStream) SendAndClose(m *CookieJar) error {
	if err := x.MsgSend(m, drpcEncoding_File_sesamestreet_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
